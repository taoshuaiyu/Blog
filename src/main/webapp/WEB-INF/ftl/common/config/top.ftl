<#macro top index>
<script baseUrl="${basePath}" src="${basePath}/js/common/user.login.js"></script>
      ...
      <div class="container" style="padding-left: 0px; padding-right: 0px;">
        <div class="navbar-header">
	     ...
	     <div role="navigation" class="navbar-collapse collapse">
	     		<a id="_logo"  href="${basePath}" style="color:#fff; font-size: 24px;" class="navbar-brand hidden-sm">小陶博客系统</a>
				...
				<@shiro.hasAnyRoles name='888888,100003'>
					<li class="dropdown ${(index==3)?string('active','')}">
                      ...
                      <li class="dropdown ${(index==4)?string('active','')}">
                          <a aria-expanded="false" aria-haspopup="true"  role="button" data-toggle="dropdown" class="dropdown-toggle" href="${basePath}/article/index.shtml">
                              文章管理<span class="caret"></span>
                          </a>
                          <ul class="dropdown-menu">
							  <#--<@shiro.hasPermission name="/article/list.shtml">-->
                                  <li><a href="${basePath}/article/index.shtml">文章列表</a></li>
							  <#--</@shiro.hasPermission>-->
                          </ul>
                      </li>
                  <li>
